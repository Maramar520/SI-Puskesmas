    ...
    <div class="box">
        ...
        <h4>
            ...
            <div class="pull-right">
                ...
                <a href="add.php" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i>Tambah Perawat</a>
            </div>
        </h4>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover" id="dokter">
                ...
                while ($data = mysqli_fetch_array($sql_perawat)) {?>
                    <tr>
                        <td align="center">
                            <input type="checkbox" name="checked[]" class="check" value="<?=$data['id_perawat']?>">
                        </td>
                        <td><?=$no++?>.</td>
